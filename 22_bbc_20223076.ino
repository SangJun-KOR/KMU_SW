...
#define _DUTY_MAX 1929 // 2000
#define _DUTY_NEU 1455 // 1500
...
#define _BANGBANG_RANGE    180  // duty up and down for bangbang control 오차 범위?
...
float volt_to_distance(int a_value)
{
  ...
  // return (6762.0 / (a_value - 9) - 4.0) * 10.0; 이거 엑셀에 있는 식으로 교체 해줘야됨
  return 675 + (-2.22 * a_value) + 1.86E-03 * a_value * a_value;
}
