...
#define LOOP_INTERVAL 20   // Loop Interval (unit: msec) 언제 측정햇을때 부드러웟다 이용 저번 시간 
...
void loop()
{
  ...
  //duty = map(dist_ema, _DIST_MIN, _DIST_MAX, _DUTY_MIN, _DUTY_MAX); // dist로 측정되는 값을 duty로 바꾸는게 map 함수 과제는 맵 쓰지 말고 계산식 작성해야됨
